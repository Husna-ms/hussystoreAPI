...
namespace HusstoreAPI.Controllers
{
    ...
    public class PaymentController : ControllerBase
    {
        ...
        public PaymentController(StoreDbContext context)
        {
            _context = context;
        }
        ...
        {
            // Retrieve all payments including the related orders
        ...
        {
            // Retrieve the specific payment by id including the related order
